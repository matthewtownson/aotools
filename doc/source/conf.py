# -*- coding: utf-8 -*-
#
# aotools documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'aotools.tex', u'aotools Documentation',
...
man_pages = [
    (master_doc, 'aotools', u'aotools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'aotools', u'aotools Documentation',
     author, 'aotools', 'One line description of project.',
     'Miscellaneous'),
]
